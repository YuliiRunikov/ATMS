...
int x, y, i;
​
const char *ssid = "ITPC home";
const char *password = "23111949";
​
String test1();
void test();
​
...
const char *serverName = "http://192.168.0.101:12345/";
...
​
    http.addHeader("Host", "any");
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");
​
    String httpRequestData = "data=[" + test1() + "]";
